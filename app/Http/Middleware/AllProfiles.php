...
class AllProfiles
{
    ...
    public function isAuth($request)
    {
        if ($request->session()->exists('token')) {
            ...
            // dump($role);
            if ($role === 'administrator' || $role === 'agent' || $role === 'cashier' || $role === 'csa' || $role === 'technical_support' || $role === 'retail_agent' || $role === 'finance_manager') {
                try {
                    ...
                    if (isset($response['id'])) {
                        if ($role === 'agent' || $role === 'cashier' || $role === 'csa' || $role === 'finance_manager') {
