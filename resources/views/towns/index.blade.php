                        ...
                        <div class="float-right d-none d-md-block">
                            <button class="btn_round_add btn-primary arrow-none waves-effect waves-light">
                                <i class="mdi mdi-plus mr-2"></i> <a style="color: #fff"
                                                                     href="{{ route('town_add') }}">Ajouter une ville</a>
                            </button>
                        </div>
                    </div>
                </div> <!-- end row -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-4">
                                Liste de toutes les villes où THOLADPAY est succeptible d'avoir des agents.
                            </p>
                            ...
                            <div class="modal fade" id="my_modal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="dialog">
                                    <form action="{{route('town_delete')}}" method="post">
                                        {{ csrf_field() }}
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" style="color: red">Suppression de la ville</h4>
                                            </div>
                                            <div class="modal-body">
                                                Voulez-vous supprimer la ville : <b id="ctryDel" style="color: red"></b>
                                                ?
