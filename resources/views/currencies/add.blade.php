        ...
        <div class="container-fluid">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title">Exchange Rate</h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin') }}"><i
                                            class="mdi mdi-home-outline"></i></a></li>
                            <li class="breadcrumb-item"><a href="{{ route('currency_list') }}">Exchange Rate</a></li>
                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title">Ajout du taux de change</h4>
