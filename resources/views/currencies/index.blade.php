                        ...
                        <!-- <div class="float-right d-none d-md-block">
                            <button class="btn_round_add btn-primary arrow-none waves-effect waves-light">
                                <i class="mdi mdi-plus mr-2"></i> <a style="color: #fff"
                                                                     href="{{ route('currency_add') }}">Ajouter un taux de change</a>
                            </button>
                        </div> -->
                        <div class="float-right d-none d-md-block">
                            <button class="btn_round_add btn-primary arrow-none waves-effect waves-light">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="datatable-buttons"
                                ...
                                <tbody>
                                @forelse ($currencies as $t)
                                    <tr>
                                        <td> {{ $t['code'] }}</td>
                                        <td style="white-space: normal"> {{ $t['symbol'] }}</td>
                                        <td style="white-space: normal"> {{ $t['rate'] }}</td>
                                        <!-- <td style="white-space: normal"> {{ $t['fees'] }}</td> -->
                                        <td>
                            ...
                            <div class="modal fade" id="my_modal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="dialog">
                                    <form action="{{route('currency_delete')}}" method="post">
                                        {{ csrf_field() }}
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" style="color: red">Suppression du taux de change</h4>
                                            </div>
                                            <div class="modal-body">
                                                Voulez-vous supprimer ce taux de change : <b id="ctryDel" style="color: red"></b>
                                                ?
