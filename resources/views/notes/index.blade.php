                        ...
                        <div class="float-right d-none d-md-block">
                            <button class="btn_round_add btn-primary arrow-none waves-effect waves-light">
                                <i class="mdi mdi-plus mr-2"></i> <a style="color: #fff"
                                                                     href="{{ route('note_add') }}">Ajouter une
                                    note</a>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-4">
                                Liste de toutes les notes, vous pouvez filtrer par transaction ou customer.
                            </p>
                            ...
                            <table id="datatable-buttons"
                                ...
                                <tbody>
                                @forelse ($mesNotes as $c)
                                    <tr>
                                        <td  style="white-space:normal"> {{$c['detail']}}</td>
                                        <!-- <td> {{$c['verifiable_type']}}</td> -->
                                        <td> {{$c['verifiable']['recipient_first_name'].' | '.$c['verifiable']['transaction_reference']}}</td>
...
{{--                                                            class="mdi mdi-block-helper"></i>{{ $c['id'].'|||'.$c['detail'] }}</a>--}}
                            ...
                            <div class="modal fade" id="my_modal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="dialog">
                                    <form action="{{route('note_delete')}}" method="post">
                                        {{ csrf_field() }}
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" style="color: red">Suppression de la note</h4>
                                            </div>
                                            <div class="modal-body">
                                                Voulez-vous supprimer la note : <b id="ctryDel" style="color: red"></b>
                                                ?
