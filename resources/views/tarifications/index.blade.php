        ...
        <div class="container-fluid">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title"> Grilles Tarifaires </h4>
                        <ol class="breadcrumb">
                        ...
                        <div class="float-right d-none d-md-block">
                            <button class="btn_round_add btn-primary arrow-none waves-effect waves-light">
                                <i class="mdi mdi-plus mr-2"></i> <a style="color: #fff"
                                                                     href="{{ route('tarif_add') }}">Ajouter une grille tarifaire</a>
                            </button>
                        </div>
                    </div>
                </div> <!-- end row -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="datatable-buttons"
                                ...
                                <tbody>
                                @forelse ($tarifications as $c)
                                    {{-- Ne pas exclure une tranche légitime commençant à 0 (ex : CEMAC 0-25000 XAF).
                                         On n'exclut que les lignes réellement vides (tout à 0). --}}
                                    @if (!($c['tarif_1'] == 0 && $c['tarif_2'] == 0 && $c['frais'] == 0))
                                        <tr>
                                            <td> {{ $c['tarif_1'] }}</td>
                                            <td> {{ $c['tarif_2'] }}</td>
                                            <td> {{ $c['frais'] }}</td>
                                            ...
                                            <td>
                                                <div class="btn-group mt-4 mt-md-0 button-items"
                                                    ...
                                                    data-id="{{ $c['id'].'|||'.$c['zone']['name'].' => '.$c['frais'] }}"
                                    ...
                                    <form action="{{route('tarif_delete')}}" method="post">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" style="color: red">Suppression de la grille tarifaire</h4>
                                            </div>
                                            <div class="modal-body">
                                                Voulez-vous supprimer la grille tarifaire : <b id="ctryDel" style="color: red"></b>
                                                ?
