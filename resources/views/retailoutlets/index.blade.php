                        ...
                        <div class="float-right d-none d-md-block">
                            <button class="btn_round_add btn-primary arrow-none waves-effect waves-light">
                                <i class="mdi mdi-plus mr-2"></i> <a style="color: #fff"
                                                                     href="{{ route('retailoutlet_add') }}">Ajouter un point</a>
                            </button>
                        </div>
                    </div>
                </div> <!-- end row -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-4">
                                Liste de tous les points de vente THOLADPAY
                            </p>
                            ...
                            <table id="datatable-buttons"
                                ...
                                <tbody>
                                @forelse ($retailOutlets as $t)
                                    <tr>
                                        <td> {{ $t['name'] }}</td>
                                        <td style="white-space: normal"> {{ $t['description'] }}</td>
                                        <td> {{ $t['town']['name'] }}</td>
                                        <td style="white-space: normal"> {{ $t['rue'] }}</td>
                                        <td>
                                            <div class="btn-group mt-4 mt-md-0 button-items"
                                                 dir="ltr" role="group"
                                                 aria-label="Basic example">
                                                <a href="{{route('retailoutlet_edit', $t['id'])}}"
                            ...
                            <div class="modal fade" id="my_modal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="dialog">
                                    <form action="{{route('retailoutlet_delete')}}" method="post">
                                        {{ csrf_field() }}
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" style="color: red">Suppression du point de vente</h4>
                                            </div>
                                            <div class="modal-body">
                                                Voulez-vous supprimer ce point de vente : <b id="ctryDel" style="color: red"></b>
                                                ?
