                        ...
                        <div class="float-right d-none d-md-block">
                            <button class="btn_round_add btn-primary arrow-none waves-effect waves-light">
                                <i class="mdi mdi-plus mr-2"></i> <a style="color: #fff"
                                                                     href="{{ route('zone_add') }}">Ajouter une zone</a>
                            </button>
                        </div>
                    </div>
                </div> <!-- end row -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-4">
                                Liste de toutes les zones où THOLADPAY op&egrave;re.
                            </p>
                            ...
                            <table id="datatable-buttons"
                                ...
                                @forelse ($zones as $t)
                                    <tr>
                                        <td> {{ $t['name'] }}</td>
                                        <td> {{ $t['description'] }}</td>
                                        <td> {{ $t['limit_transac_day'] }}</td>
                                        <td>
                                            <div class="btn-group mt-4 mt-md-0 button-items"
                                                 dir="ltr" role="group"
                                                 aria-label="Basic example">
                                                <a href="{{route('zone_edit', $t['id'])}}"
                            ...
                            <div class="modal fade" id="my_modal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="dialog">
                                    <form action="{{route('zone_delete')}}" method="post">
                                        {{ csrf_field() }}
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" style="color: red">Suppression de la zone</h4>
                                            </div>
                                            <div class="modal-body">
                                                Voulez-vous supprimer la zone : <b id="ctryDel" style="color: red"></b>
                                                ?
