                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title">Ajout d'un nouveau utilisateur</h4>
...
@section('javascripts')
    ...
    <script type="text/javascript">
        ...
        function role(input) {
            ...
            $("#blockFinance").attr("style", "display:none");
            if (role.split('|')[1] === 'agent' || role.split('|')[1] === 'finance_manager') {
                $("#txtNomC").val('');
                ...
                // if (role.split('|')[1] === 'caissier' || role.split('|')[1] === 'csa' || role.split('|')[1] === 'retail_agent' || role.split('|')[1] === 'technical_support' || role.split('|')[1] === 'finance_manager') {
                if (role.split('|')[1] === 'cashier') {
                    $("#idAgent").val('');
                    $("#blockAgent").attr("style", "display:block");
                }
                if (role.split('|')[1] === 'csa') {
                    $("#idFinance").val('');
                    $("#blockFinance").attr("style", "display:block");
                }
            }
        }
